...
public class PlayerStats : EntityStats<PlayerStats>
{
    ...
    public float runningTopSpeed = 9f;      // 奔跑最高速度
    ...
    public float minGrindSpeed = 100f;           // 最小滑行速度
    public float grindTopSpeed = 100f;          // 最大滑行速度
    public float grindDownSlopeForce = 50f;    // 下坡时推力
    public float grindUpSlopeForce = 40f;      // 上坡时推力
